	...
	switch	state{
		...
		case 2:
			...
			if sprite_index == spr_CH_root_idle{
				...
				if obj_CH_tree_state.ph == 1 and swing == false{
		...
		case 5:
			...
			if jab == true and place_meeting(x,y,global.body){
				global.p_stats[stats.hp] -= 3;
				visible = true;
				global.p_hurt = true;
			
			}
		
			if image_index >= 18 and sprite_index != spr_CH_root_idle{
				sprite_index = spr_CH_root_idle;
				image_speed = 1;
				jab = false;
		...
		case 6:
			...
			}else if image_index <= 1 and visible == true{
				image_speed = 0;
				visible = false;
