switch state{
	...
	case "play":
		...
		if scr_GUI_button(305 * global.gui_ratio, 258 * global.gui_ratio,
						  (342-305) * global.gui_ratio, (275-258) * global.gui_ratio) or
	...
	case "options":
		...
		if scr_GUI_button(294 * global.gui_ratio, 289 * global.gui_ratio,
						  (354-294) * global.gui_ratio, (306-289) * global.gui_ratio) or
						  global.key_active[key_id.m_confirm]{
	...
	case "quit":
		...
		if scr_GUI_button(304 * global.gui_ratio,323 * global.gui_ratio,
						  (338-304) * global.gui_ratio, (337-323) * global.gui_ratio) or
						  global.key_active[key_id.m_confirm] {
