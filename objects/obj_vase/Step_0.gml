if (place_meeting(x,y,obj_sword_projectile_impact) or place_meeting(x,y,obj_greatswing) or place_meeting(x,y,obj_explosion) or place_meeting(x,y,obj_e_arrow)){
